    ...
    const logs = [
        {
            ...
            features: [
                "活動詳情頁移除重複報名按鈕、緊湊化佈局",
                "活動標籤改為純英文顯示",
                "新增「參與條件」欄位（預設選項 + 自訂輸入）",
                "探索頁 Tag 拆分（移除 & 連結）",
                "全新「行程時間線」頁面：時間軸樣式、按日期分組",
                "時間線支援取消報名、出示驗證碼、刪除歷史",
                "新增活動/俱樂部所有權轉讓功能",
                "行動版底部導航改為 5 個 Tab（票夾深色特殊化）",
                "管理後台側邊欄支援拖拽調整順序並記憶",
                "修復探索頁標題間距過大問題",
            ],
            type: "major"
        },
        {
            ...
            features: [
                "俱樂部創建動效：Duolingo 風格讀條 + 成功禮花",
                "KOL 身份申請頁面：驗證職業、社媒帳號與粉絲數",
                "我的俱樂部改為縱向卡片樣式",
                "設定頁「社群與商務」區塊全面中文化",
                "俱樂部管理頁面使用真實 API 數據",
                "修復 club_members RLS 無限遞迴問題",
            ],
            type: "major"
        },
        {
